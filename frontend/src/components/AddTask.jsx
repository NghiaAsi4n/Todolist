...
const AddTask = ({ handleNewTaskAdded }) => {
    ...
    const addTask = async () => {
        if (newTaskTitle.trim()) {
            ...
            //Thông báo với component cha để refresh danh sách
            handleNewTaskAdded();
            } catch (error){
        ...
        <Card className = "p-6 border-0 bg-gradient-card shadow-custome-lg">
            <div className = "flex flex-col gap-3 sm:flex-row">
                <Input
                    ...
                    className = "h-12 text-base bg-slate-50 sm:flex-1 border-border/50 focus:border-primary/50 focus:ring-primary/20 placeholder:text-gray-400"
